         ...
         (letfn
           [(validate-items [candidate]
            ...
            (compare-full [[cand1 num-ch1 :as pair1] [cand2 num-ch2 :as pair2]]
              (validate-items cand1) (validate-items cand2)
